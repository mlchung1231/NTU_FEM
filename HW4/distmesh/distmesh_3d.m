...
%
%    real H0, the initial smallest edge length.
%
%    real BOX(3,2), a bounding box for the region.
%
...
%
%    real PFIX(NFIX,3), the coordinates of nodes that are
...
%  Output:
%
%    real P(N,3), node coordinates.
%
%    integer T(NT,4), tetrahedron indices.
%
  dim = 3;
  ptol = 0.001; 
  ttol = 0.1; 
