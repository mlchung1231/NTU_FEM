...
[coor, conn, ndime, mate, nnode, nelem, nelnd, npres, pres, nload, load, ntrac, trac] = ReadInput('hw6_1_inputfile.h5');
...
for i = 2:nstpho+1
    ...
    e_plot = [e_plot, abs(wglob(22,1)/10)];
    s_plot = [s_plot, abs(fglob(22,1))];
end
figure(5);
plot(e_plot, s_plot);
xlabel('Strain');
