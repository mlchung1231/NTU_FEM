...
[p,t] = distmesh_2d( fd, fh1, 1, [-45,-45;45,45], 500 , [-45,-45;-45,45;45,-45;45,45] );
...
colorbar; colormap jet; title('HW3 (1) Signed distance function');
figure('color','w'); dist_plot(p,t,fh2); axis equal on; box on; xlabel('X-axis'); ylabel('Y-axis');
colorbar; colormap jet; title('HW3 (1) Mesh density function');
